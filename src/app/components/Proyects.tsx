...
const Proyects = () => {
    return (
        <div className='flex justify-center pb-20'>
            <div className='bg-gray-50 py-20 w-full lg:w-4/5 shadow-xl flex items-center flex-col p-5 lg:p-16'>
                <div className='pb-10 lg:pb-20 flex items-center flex-col w-full'>
                    <h2 className='lg:mx-14 text-xl lg:text-4xl pb-5'>PROJECTS</h2>
                    <hr className='w-3/4' />
                </div>
                {proyectList.map(p =>
                    <div key={p.title} className='flex flex-col content-center flex-nowrap lg:flex-row
                     bg-gray-200 items-center mb-16 w-full shadow-xl pb-10'>
                        ...
                        {/* <Image className='p-5 lg:p-0 w-full lg:w-1/2' src={p.imagePath} alt='Picture of the proyect'
                            ...
                            width={50}
                            height={50} /> */}
                        <div className='p-5 lg:p-0 w-full h-full lg:w-1/2 flex items-center'>
                            <ProjectsCarrousel />
                        </div>
                    </div>
                )}
